...
BitBalloon uses OAuth2 for authentication. All requests must use HTTPS. You'll need an application client key and a client secret before you can access the BitBalloon API. You can register a new application at [https://www.bitballoon.com/applications](https://www.bitballoon.com/applications).
